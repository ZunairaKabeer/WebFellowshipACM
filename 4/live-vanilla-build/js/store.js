const initialValue = { currentGameMoves: [],
history: {
    currentRoundGames: [], 
    allGames: [] 
} };
...
export default class Store {
    ...
    get game(){
       ...
       const currentPlayer=this.player[state.currentGameMoves.length % 2];
    ...
    for(const player of this.players){
        const selectedSquareIds=state.currentGameMoves.filter(move=>move.player.id===player).map(move=>move.squareId);
        }
